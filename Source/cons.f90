...
CHARACTER(255), PARAMETER :: consid='$Id: cons.f90 21064 2014-11-25 19:31:36Z mcgratta $'
CHARACTER(255), PARAMETER :: consrev='$Revision: 21064 $'
CHARACTER(255), PARAMETER :: consdate='$Date: 2014-11-25 14:31:36 -0500 (Tue, 25 Nov 2014) $'
...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
