...
IMPLICIT NONE
CHARACTER(255), PARAMETER :: typeid='$Id: type.f90 21033 2014-11-20 19:20:30Z drjfloyd@gmail.com $'
CHARACTER(255), PARAMETER :: typerev='$Revision: 21033 $'
CHARACTER(255), PARAMETER :: typedate='$Date: 2014-11-20 14:20:30 -0500 (Thu, 20 Nov 2014) $'
...
INTEGER, PARAMETER :: N_WALL_SCALAR_REALS=17,N_WALL_SCALAR_INTEGERS=11,N_WALL_SCALAR_LOGICALS=0
...
TYPE SURFACE_TYPE
   REAL(EB) :: TMP_FRONT=-1._EB,TMP_BACK=-1._EB,VEL,VEL_GRAD,PLE,Z0,CONVECTIVE_HEAT_FLUX,NET_HEAT_FLUX, &
               ...
               MINIMUM_LAYER_THICKNESS,INNER_RADIUS=0._EB,MASS_FLUX_VAR=-1._EB
